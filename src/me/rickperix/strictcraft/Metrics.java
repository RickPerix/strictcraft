...
/*
 * This me.rickperix.minecalc.Metrics class was auto-generated and can be copied into your project if you are
...
public class Metrics {
    ...
    /**
     * Creates a new me.rickperix.minecalc.Metrics instance.
     *
    ...
    public static class MetricsBase {
        ...
        /** The version of the me.rickperix.minecalc.Metrics class. */
        ...
        public MetricsBase(
            ...
            ScheduledThreadPoolExecutor scheduler =
                    new ScheduledThreadPoolExecutor(
                            1,
                            task -> {
                                Thread thread = new Thread(task, "bStats-me.rickperix.minecalc.Metrics");
        ...
        private void startSubmitting() {
            ...
            // WARNING: You must not modify and part of this me.rickperix.minecalc.Metrics class, including the
        ...
        private void sendData(JsonObjectBuilder.JsonObject data) throws Exception {
            ...
            connection.setRequestProperty("User-Agent", "me.rickperix.minecalc.Metrics-Service/1");
        ...
        private void checkRelocation() {
            ...
            if (System.getProperty("bstats.relocatecheck") == null
                ...
                if (MetricsBase.class.getPackage().getName().startsWith(defaultPackage)
                    ...
                    throw new IllegalStateException("bStats me.rickperix.minecalc.Metrics class has not been relocated correctly!");
                }
            }
        }
